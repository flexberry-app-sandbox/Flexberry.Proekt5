...
namespace IIS.Proekt
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Proekt.ЕдИзм fЕдИзм;
        ...
        public virtual IIS.Proekt.ЕдИзм ЕдИзм
        {
            get
            {
                ...
                IIS.Proekt.ЕдИзм result = this.fЕдИзм;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Proekt.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Proekt.Товары));
                }
            }
        }
    }
